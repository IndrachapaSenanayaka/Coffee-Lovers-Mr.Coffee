                ...
                if (!TextUtils.isEmpty(hno)) {
                    if (!TextUtils.isEmpty(sno)) {
                        if (!TextUtils.isEmpty(name)) {
                            ...
                            Toast.makeText(com.example.appcart.delivery.this, "Delivery Details filled Successfully", Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(com.example.appcart.delivery.this, "Please Enter Your Name ", Toast.LENGTH_LONG).show();
                    }

                } else {
                    Toast.makeText(com.example.appcart.delivery.this, "Please Street Number", Toast.LENGTH_LONG).show();
                }

            } else {
                Toast.makeText(com.example.appcart.delivery.this, "Please Enter House Number", Toast.LENGTH_LONG).show();
            }

        } else{
            Toast.makeText(com.example.appcart.delivery.this, "Please Enter Mobile Number", Toast.LENGTH_LONG).show();
