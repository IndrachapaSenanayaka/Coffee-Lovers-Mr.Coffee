...
public class deliveryupdate extends AppCompatActivity {
    ...
    public void Confirm(View view) {
        ...
        Toast.makeText(deliveryupdate.this, "Delivery Updated Successfully", Toast.LENGTH_LONG).show();
    ...
    public void Delete(View view) {
        ...
        Toast.makeText(deliveryupdate.this, "Delivery Cancelled ", Toast.LENGTH_LONG).show();
        etCity.setText("");
        etSno.setText("");
        etHno.setText("");
        etPno.setText("");
